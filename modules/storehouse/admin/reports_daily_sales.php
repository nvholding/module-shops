...
$daily_sales =  $rp->daily_sales($_SESSION[$module_data . '_store_id'], $_SESSION[$module_data . '_store_warehouse_id'],$year,$month);
...
//print_r($daily_sales);die;
$xtpl->assign('calender', $daily_sales->calender);
if (!empty($error)) {
